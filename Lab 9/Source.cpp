...
void middle() {
	...
	- станци€ прибыти€;
	- врем€ прибыти€;
	¬ывести сведени€ по всем поездам с указанием длительности времени пребывани€ в пути;
	¬ывести два значени€ времени и вывести дл€ данного интервала времени все сведени€ о поездах,
	которые отправл€ютьс€ из  иева.*/
